...
user_primary_collection = db["User_Primary_without_index"]
session_user_data_collection = db["Session_User_data_without_index"]
user_total_data_collection = db["User_Total_data_without_index"]
